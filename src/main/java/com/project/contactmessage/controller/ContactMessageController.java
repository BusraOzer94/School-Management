...
@RequiredArgsConstructor // Bu anatasyon ile @Autowired kullanmadan final yada @NonNull ile isaretli alanlar icin param li constr olusturur
public class ContactMessageController {

    private final ContactMessageService contactMessageService; // final yazdigimiz nesneyi bir kere conts icinde setleyebiliriz. Yoksa null olur
    ...
    // ODEV: No Content Type 204 kodu arastir
    ...
    @GetMapping("/searchBetweenDates")  //http://localhost:8080/contactMessages/searchBetweenDates?beginDate=2024-05-13&endDate=2024-05-25  + GET
